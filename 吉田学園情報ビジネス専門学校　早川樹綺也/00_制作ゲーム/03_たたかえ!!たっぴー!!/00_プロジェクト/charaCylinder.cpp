//*****************************************************************************
//
//     キャラセレクト用の円筒処理[charaCylinder.cpp]
//     Auther:Hodaka Niwa
//
//*****************************************************************************
...
//    コンストラクタ
//=============================================================================
CCharaCylinder::CCharaCylinder(int nPriority, OBJTYPE objType) : CMeshCylinder(nPriority, objType)
{
...
//    生成処理
//=============================================================================
CCharaCylinder *CCharaCylinder::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float fHeight, float fRadius, int nXBlock, int nYBlock, float fDecay, float fMag, float fUpValue, int nPriority)
{
	CCharaCylinder *pGoalCylinder = NULL;   // ゴール用円筒クラス型のポインタ
	if (pGoalCylinder == NULL)
	{// メモリが空になっている
		pGoalCylinder = new CCharaCylinder(nPriority);
		if (pGoalCylinder != NULL)
		{// インスタンスを生成できた
...
//    初期化処理
//=============================================================================
HRESULT CCharaCylinder::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float fHeight, float fRadius, int nXBlock, int nYBlock, float fDecay, float fMag, float fUpValue)
{
	// 各種値の代入
...
//    終了処理
//=============================================================================
void CCharaCylinder::Uninit(void)
{
	// 共通の終了処理
...
//    更新処理
//=============================================================================
void CCharaCylinder::Update(void)
{
	// 色を取得
...
//    頂点バッファ生成処理
//=============================================================================
void CCharaCylinder::MakeVertex(const LPDIRECT3DDEVICE9 pDevice)
{
	// 頂点バッファの生成
...
//    減衰値を設定する処理
//=============================================================================
void CCharaCylinder::SetDecay(const float fDecay)
{
	m_fDecay = fDecay;
}
...
//    倍率を設定する処理
//=============================================================================
void CCharaCylinder::SetMag(const float fMag)
{
	m_fMag = fMag;
}
...
//    倍率を加算する量を設定処理
//=============================================================================
void CCharaCylinder::SetUpValue(const float fUpValue)
{
	m_fUpValue = fUpValue;
}
...
//    減衰値を取得する処理
//=============================================================================
float CCharaCylinder::GetDecay(void)
{
	return m_fDecay;
}
...
//    倍率を取得する処理
//=============================================================================
float CCharaCylinder::GetMag(void)
{
	return m_fMag;
}
...
//    倍率を加算する量を取得する処理
//=============================================================================
float CCharaCylinder::GetUpValue(void)
{
	return m_fUpValue;
}